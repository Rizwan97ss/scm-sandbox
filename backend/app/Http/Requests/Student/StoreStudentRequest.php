...
class StoreStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'guardians.*.first_name' => ['required_without:guardians.*.guardian_id', 'string', 'max:100', new ValidName],
            'guardians.*.last_name' => ['required_without:guardians.*.guardian_id', 'string', 'max:100', new ValidName],
